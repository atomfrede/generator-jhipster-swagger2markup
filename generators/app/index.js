...
module.exports = yeoman.generators.Base.extend({
  ...
  prompting() {
    ...
    this.log(yosay(`Welcome to the ${chalk.red('JHipster swagger2markup')} generator! ${chalk.yellow('v' + packagejs.version)}`));
  ...
  writing() {
    ...
    const javaTestDir = `src/test/java/${this.packageFolder}/`;
    ...
    if (this.buildTool === 'gradle') {
      ...
      const swagger2markupPuginDependencies = '                <dependencies>\n' +
                    '                  <dependency>\n' +
      ...
      let swagger2markupConfiguration = '                <configuration>\n' +
      ...
      const asiidoctorjConfiguration = '                <configuration>\n' +
